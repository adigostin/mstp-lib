...
public:
	...
	virtual void Render (ID2D1RenderTarget* rt, const DrawingObjects& dos, uint16_t vlanNumber) const override final;
...
private:
	bool IsForwardingOnVlan (uint16_t vlanNumber, _Out_opt_ bool* hasLoop) const;
};
