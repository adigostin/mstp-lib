...
struct PortRoleTransitionsImpl : PortRoleTransitions
{
...
const SM_INFO<PortRoleTransitions::State> PortRoleTransitions::sm = {
	"PortRoleTransitions",
	&PortRoleTransitionsImpl::GetStateName,
	&PortRoleTransitionsImpl::CheckConditions,
	&PortRoleTransitionsImpl::InitState
};
