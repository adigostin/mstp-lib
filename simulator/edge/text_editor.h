...
namespace edge
{
	...
	using text_editor_factory_t = std::unique_ptr<text_editor_i>(d2d_window_i* window, IDWriteFactory* dwrite_factory, IDWriteTextFormat* format, uint32_t fill_argb, uint32_t text_argb, const D2D1_RECT_F& rect, float lr_padding, std::string_view text);
