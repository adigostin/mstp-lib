...
struct L2GPortReceiveImpl : L2GPortReceive
{
...
const SM_INFO<L2GPortReceive::State> L2GPortReceive::sm = 
{
	"L2GPortReceive",
	&L2GPortReceiveImpl::GetStateName,
	&L2GPortReceiveImpl::CheckConditions,
	&L2GPortReceiveImpl::InitState
};
