...
bool allSynced			(const STP_BRIDGE*, int givenPort, int givenTree); // 13.26.a) - 13.26.1
bool allTransmitReady	(const STP_BRIDGE*, int givenPort); // 13.26.b) - 13.26.2
bool cist				(const STP_BRIDGE*, int givenTree); // 13.26.c) - 13.26.3
bool cistRootPort		(const STP_BRIDGE*, int givenPort); // 13.26.d) - 13.26.4
bool cistDesignatedPort	(const STP_BRIDGE*, int givenPort); // 13.26.e) - 13.26.5
unsigned short EdgeDelay    (const STP_BRIDGE*, int givenPort); // 13.26.f) - 13.26.6
unsigned short forwardDelay (const STP_BRIDGE*, int givenPort); // 13.26.g) - 13.26.7
unsigned short FwdDelay     (const STP_BRIDGE*, int givenPort); // 13.26.h) - 13.26.8
unsigned short HelloTime    (const STP_BRIDGE*, int givenPort); // 13.26.i) - 13.26.9
unsigned short MaxAge	    (const STP_BRIDGE*, int givenPort); // 13.26.j) - 13.26.11
bool msti				(const STP_BRIDGE*, int givenTree);		// 13.26.k) - 13.26.10
bool mstiDesignatedOrTCpropagatingRootPort (const STP_BRIDGE*, int givenPort); // 13.26.l) - 13.26.12
bool mstiMasterPort		(const STP_BRIDGE*, int givenPort);		// 13.26.m) - 13.26.13
bool rcvdAnyMsg			(const STP_BRIDGE*, int givenPort);		// 13.26.o) - 13.26.15
bool rcvdCistMsg		(const STP_BRIDGE*, int givenPort);		// 13.26.p) - 13.26.16
bool rcvdMstiMsg		(const STP_BRIDGE*, int givenPort, int givenTree);	// 13.26.q) - 13.26.17
bool reRooted			(const STP_BRIDGE*, int givenPort, int givenTree);	// 13.26.r) - 13.26.18
bool rstpVersion		(const STP_BRIDGE*);						// 13.26.s) - 13.26.19
bool stpVersion			(const STP_BRIDGE*);						// 13.26.t) - 13.26.20
bool updtCistInfo		(const STP_BRIDGE*, int givenPort);		// 13.26.u) - 13.26.21
bool updtMstiInfo		(const STP_BRIDGE*, int givenPort, int givenTree); // 13.26.v) - 13.26.22
bool rcvdXstMsg			(const STP_BRIDGE*, int givenPort, int givenTree); // not in the standard
bool updtXstInfo		(const STP_BRIDGE*, int givenPort, int givenTree); // not in the standard
