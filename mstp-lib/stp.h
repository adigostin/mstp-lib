...
enum STP_PROPERTY
{
	...
	STP_PROP_AUTO_EDGE,
	STP_PROP_OPER_EDGE,
	STP_PROP_DETECTED_P2P,
	STP_PROP_ADMIN_P2P,
	STP_PROP_OPER_P2P,
	STP_PROP_PORT_ENABLED,
	STP_PROP_PORT_ROLE,
	STP_PROP_MST_CONFIG_NAME,
	STP_PROP_MST_CONFIG_REVISION_LEVEL,
	STP_PROP_MST_CONFIG_TABLE,
	STP_PROP_ROOT_PRIORITY_VECTOR,
	STP_PROP_ROOT_TIMES,
	STP_PROP_BRIDGE_STARTED,
	STP_PROP_STP_VERSION,
	STP_PROP_BRIDGE_TREE_PRIORITY,
	STP_PROP_ADMIN_EXTERNAL_PORT_PATH_COST,
	STP_PROP_DETECTED_PORT_PATH_COST,
	STP_PROP_EXTERNAL_PORT_PATH_COST,
	STP_PROP_INTERNAL_PORT_PATH_COST,
};
