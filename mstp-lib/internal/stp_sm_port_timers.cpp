...
struct PortTimersImpl : PortTimers
{
...
const SM_INFO<PortTimers::State> PortTimers::sm = {
	"PortTimers",
	PortTimersImpl::GetStateName,
	PortTimersImpl::CheckConditions,
	PortTimersImpl::InitState
};
